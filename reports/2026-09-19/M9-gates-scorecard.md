...
> **Tanggal Sertifikasi**: 2026-09-19
...
| **G-M9-3** | **Decode Streaming & Reuse** | $\ge 0.5\text{ tok/s} \wedge$ `recompute == 0` | recompute: 0, kv_tokens: 8 $\to$ 9, Throughput: 118.6 tok/s | **[PASS]** |
...
| **F11b-GGUF**| **File Size Exact Match** | $\Delta_{size} \equiv 0\text{ byte}$ vs analitis | Ukuran: 762080 B, $\Delta_{size} = 0\text{ B}$ | **[PASS]** |
